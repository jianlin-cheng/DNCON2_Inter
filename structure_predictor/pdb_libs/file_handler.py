...
def job_docking(_cns_solve_dir,_output_dir):
    content = file_reader('job_docking.txt')
    final_content = content.replace('_cns_solve_source_replace_', _cns_solve_dir)  # replace source   _cns_solve_source_replace_
    final_content = final_content.replace('_output_file_directory_replace_', _output_dir)  # restrains    _output_file_directory_replace_
