...
# _target_id='1I88'
#for Calla
CNS_DIRECTORY = '/exports/store1/casp14_capri/tools/cns_solve_1.3/'
prog_dir = '/exports/store1/casp14_capri/structure_predictor'
#for ginger
...
def main():
    ...
    os.system('cp ' + details_array_all[0][0] + ' ' + output_file + '/initialized.pdb')
