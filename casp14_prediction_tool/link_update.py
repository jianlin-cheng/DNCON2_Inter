...
for i in range (3):
    ...
    command=command+"python "+dirnm+"/structure_predictor/structure_predictor.py "+_id+" "+new_pdb_list[0]+" "+new_pdb_list[1]+" "+outfolder+_id+"_inter_nointra_relax_remove_"+str(i)+".rr "+outdir_list[i] + "> structure_prediction_"+sym+"_"+_id+"_"+str(i)+".log & "
#    sys.exit()
print ("\nRunning command ...\n")
print (command)
print("")
...
print ("The final structures will be available in the folder "+outfolder+_id+"_inter_nointra_relax_remove_0/"+_id+"/initialized.pdb")
