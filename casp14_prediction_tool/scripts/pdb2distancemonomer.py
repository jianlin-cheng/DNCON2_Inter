...
print ("PDB Fasta Length=",len(fasta),"\n",fasta,"\nFasta File Fasta Length=",len(f_fasta),"\n",f_fasta)
    
L=len(f_fasta)
#print (L)
#print (fasta)
if (f_fasta != fasta): 
    print("fasta sequence in provided fasta file does not match with the PDB.")
    print("Using Fasta File fasta_sequence...")
...
outfile_dist=outfile+"_dist"+".txt"
outfile_rr=outfile+".rr"
distribution.insert(0,f_fasta+"\n")
rr_distribution.insert(0,f_fasta+"\n")
